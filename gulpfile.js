...
const preprocessor = {
    ...
    preName: 'sass' // Имя препроцессора 'less', 'sass', 'stylus'
};
...
gulp.task('clean', function (cb) { //Удалить продакшен
    del.sync([path.clean], cb);
});

gulp.task('sprite', function () { // Создание спрайтов
